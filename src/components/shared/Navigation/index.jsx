...
const Navigation = () => {
  ...
  return (
    <Navbar  bg="light" expand="lg">
      <Navbar.Brand>Mo Rev</Navbar.Brand>
      <Navbar.Toggle aria-controls="basic-navbar-nav"/>
      <Navbar.Collapse id="basic-navbar-nav">
        <Nav className="mr-auto">
          <Link to="/" component={NavLink}>Home</Link>
          <Link to="/reviews" component={NavLink}>Malcolm X</Link>
          <Link to="/reviews2" component={NavLink}>Fight Club</Link>
          <Link to="/reviews3" component={NavLink}>Titanic</Link>
          <Link to="/reviews4" component={NavLink}>Joker</Link>
